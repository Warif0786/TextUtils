      ...
      <div className="accordion" id="accordionExample">
        ...
        <div className="accordion-item">
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                TextUtils reports the number of words and charcters. Thus it is suitable for writing text with word/ charcters limit...
            </div>
            </div>
        </div>
        <div className="accordion-item">
            ...
            <div className="accordion-body" style={myStyle}>
                ...
                suits to count charcters in facebook, blog, books, excel document, pdf document, essays, etc...
            </div>
            </div>
        </div>
    </div>
